...
class TestPinWeightTransport:
    async def test_pin_sends_the_checkpoint_dir_as_the_http_model_path(self, router_always_ready):
...
class TestPinFailureModes:
    async def test_pin_retries_a_transient_load_failure_and_then_succeeds(self, router_always_ready):
    ...
    async def test_pin_skips_when_every_attempt_fails(self, router_always_ready):
    ...
    async def test_pin_skips_when_a_weight_load_hangs_past_the_timeout(self, router_always_ready, monkeypatch):
    ...
    async def test_pin_skips_when_the_fleet_reads_no_client_at_all(self, router_always_ready):
