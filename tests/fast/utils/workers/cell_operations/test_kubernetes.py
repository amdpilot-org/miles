...
class TestInjectFault:
    def test_calls_the_worker_the_sub_index_picks(self):
        ...
        asyncio.run(operations.inject_fault(cell_id="engine-0", cell_type=ROLLOUT_CELL_TYPE, mode=FailureMode.SIGKILL, sub_index=1))
    ...
    def test_passes_the_requested_mode_to_the_worker(self):
        ...
        asyncio.run(operations.inject_fault(cell_id="engine-0", cell_type=ROLLOUT_CELL_TYPE, mode=FailureMode.SEGFAULT, sub_index=0))
    ...
    def test_a_worker_that_dies_before_answering_is_a_success(self):
        ...
        asyncio.run(operations.inject_fault(cell_id="engine-0", cell_type=ROLLOUT_CELL_TYPE, mode=FailureMode.SIGKILL, sub_index=0))
