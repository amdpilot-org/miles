import pytest
from tests.e2e.deploy.conftest_deploy.common.example_args import assert_the_example_builds_the_parallelism_of
...
class TestAssertTheExampleBuildsTheParallelismOf:
    ...
    def test_an_example_that_never_builds_the_flag_at_all_is_caught(self):
        ...
        with pytest.raises(AssertionError, match="builds no --context-parallel-size at all"):
            assert_the_example_builds_the_parallelism_of(_mode("--context-parallel-size 2"), train_args="--lr 1e-6 ")
