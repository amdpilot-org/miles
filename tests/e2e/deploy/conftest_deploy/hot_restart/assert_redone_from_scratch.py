...
def assert_a_run_that_had_saved_nothing_was_redone_from_scratch(
    *,
    ...
    scheduled = _read_the_one_freeze_of_a_run_that_saves_nothing_before_it(schedule)
    ...
    _assert_the_run_saved_after_it_was_restarted(
...
def _read_the_one_freeze_of_a_run_that_saves_nothing_before_it(
    schedule: Sequence[ScheduledFreeze],
) -> ScheduledFreeze:
...
def _assert_the_run_saved_after_it_was_restarted(
    *, checkpoint_dir: str, dump_dir: str, frozen_rollout_id: int
) -> None:
