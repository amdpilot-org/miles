...
from miles.utils.async_utils import with_exit_stack
...
async def main(args, *, disposer: AsyncExitStack):
    assert (
        not args.colocate
    ...
    disposer.push_async_callback(controller.stop)
...
if __name__ == "__main__":
    args = parse_args()
    asyncio.run(with_exit_stack(main, args))
